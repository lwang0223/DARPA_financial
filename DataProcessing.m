...
%%%%%%%%%%%%%%%%%Define sDimVec here%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sDimVec = 10*ones(size(vol1StatesEFI,2),1);

%%%%%%%%%%%%%%%Turn cell structure to a matrix and write to Excel%%%%%%%%%%
bMat = [];
statesMat = vol1StatesEFI; %Finite discrete states matrix
...
csvwrite('vol1BnryStatesEFI.csv',bMat);
...
xlswrite('vol1NodeNames.xlsx',tikNodes);
